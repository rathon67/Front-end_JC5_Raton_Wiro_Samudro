...
class TambahdetailShocks extends Component {
    state= {
                                        ...
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="card">
                                                    ...
                                                    <h3 className="title">Tambah Data Detail Shocks</h3><p></p>
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <div className="col-lg-8">
                                                                    <input name="gambarshocks" onChange={this.onchange} type="file" className="form-control"  placeholder="input gambar"/>
                                                                </div>
                                                            </div>
                                                            <div className="form-group">
                                                                    <label htmlFor="description" className="col-sm-2 control-label">Edit Deskripsi </label>
                                                                    <div className="col-sm-8">
                                                                        <input ref="descshocks" type='text' style={{height:250}} placeholder="Edit Deskripsi" className="form-control" />
                                                                    </div>
                                                            </div>                                                                                                   
                                                            ...
                                                            <div className="form-group">
                                                                <div className="col-lg-10 col-lg-offset-2">
                                                                    ...
                                                                    <Link to="/tambahdetailbrakes" className="btn btn-primary" ><i className="fa fa-arrow-right"></i>Tambah Detail Brakes</Link>
...
export default TambahdetailShocks;