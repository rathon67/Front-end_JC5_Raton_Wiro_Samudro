...
class Producttambah extends Component {
    ...
    //     axios.get('http://localhost:8002/Producttambah/'+id_sblm).then(
    //         (hasilambil) => {
    ...
    updateData = (e) =>{
        ...
        axios.post('http://localhost:8002/Producttambah/', formData);
    }
                                                        ...
                                                        <fieldset> 
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <div className="col-sm-8">
                                                                    <input ref="juduliklan" type="text" className="form-control" placeholder="Edit Judul Iklan"/>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <div className="col-sm-8">
                                                                    <input ref="namauser" type="text" className="form-control" placeholder="Edit Nama User" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <div className="col-sm-8">
                                                                    <textarea style={{height:300}} placeholder="Edit Deskripsi" className="form-control" />
                                                                </div>
                                                            </div>
