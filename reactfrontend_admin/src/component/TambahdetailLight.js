                                        ...
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="card">
                                                    ...
                                                    <h3 className="title">Tambah Data Detail Lampu</h3><p></p>
                                                        ...
                                                        <fieldset> 
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <div className="col-lg-8">
                                                                    <input name="gambarlampu" onChange={this.onchange} type="file" className="form-control" id="inputGambar" placeholder="input gambar lampu"/>
                                                                </div>
                                                            </div>
                                                            <div className="form-group">
                                                                    <label htmlFor="description" className="col-sm-2 control-label">Edit Deskripsi lampu</label>
                                                                    <div className="col-sm-8">
                                                                        <input ref="desclampu" type='text' style={{height:250}} placeholder="Edit Deskripsi" className="form-control" />
                                                                    </div>
                                                            </div>                                                                                                   
                                                            ...
                                                            <div className="form-group">
                                                                <div className="col-lg-10 col-lg-offset-2">
                                                                    ...
                                                                    <Link to="/tambahdetailsadle" className="btn btn-primary" ><i className="fa fa-arrow-right"></i>Tambah Detail sadle</Link>
...
export default TambahdetailLight;