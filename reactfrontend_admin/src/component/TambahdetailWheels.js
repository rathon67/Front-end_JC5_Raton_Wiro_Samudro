...
class TambahdetailWheels extends Component {
    state= {
                                        ...
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="card">
                                                    ...
                                                    <h3 className="title">Tambah Data Detail Wheels</h3><p></p>
                                                ...
                                                <div className="container">
                                                    <form className="form-horizontal" onSubmit={this.tambahData} encType="multipart/form-data">
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <div className="form-group">
                                                                <label className="col-lg-2 control-label">Gambar Detail Wheels</label>
                                                                <div className="col-lg-8">
                                                                    <input name="gambarwheels" onChange={this.onchange} type="file" className="form-control"  placeholder="input gambar"/>
                                                                </div>
                                                            </div>
                                                            <div className="form-group">
                                                                    <label htmlFor="description" className="col-sm-2 control-label">Edit Deskripsi </label>
                                                                    <div className="col-sm-8">
                                                                        <input ref="descwheels" type='text' style={{height:250}} placeholder="Edit Deskripsi" className="form-control" />
                                                                    </div>
                                                            </div>                                                                                                   
                                                            ...
                                                            <div className="form-group">
                                                                <div className="col-lg-10 col-lg-offset-2">
                                                                    ...
                                                                    <Link to="/tambahdetailmesin" className="btn btn-primary" ><i className="fa fa-arrow-right"></i>Tambah Detail Mesin</Link>
...
export default TambahdetailWheels;